                    ...
                    <form class="form-horizontal" id="ib_modal_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-3"><label for="status">{$_L['Status']}</label>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-5">
                                        <div class="mb-3"><label for="first_name">{$_L['First Name']}</label>
...
{*                                    </div>*}
                                    <div class="col-md-5">
                                        <div class="mb-3"><label for="last_name">{$_L['Last Name']}<small class="red">*</small></label>
                                ...
                                <div class="mb-3"><label for="title">{$_L['Title']}</label>
                                    <input type="text" id="title" name="title" class="form-control" value="{$val['title']}">
                                </div>

                                <div class="mb-3"><label for="company">{$_L['Company']}</label>
                                ...
                                <div class="mb-3"><label for="">{$_L['Phone']}</label>
                                    <input type="text" id="phone" name="phone" class="form-control" value="{$val['phone']}">
                                </div>



                                <div class="mb-3"><label for="source">{$_L['Source']}</label>
                                    <select class="form-select" id="source" name="source">
                                        <option value="None">--{$_L['None']}--</option>
                                        {foreach $sources as $source}
                                            <option value="{$source['sname']}"
                                            {if $val['source'] eq $source['sname']}selected{/if}>{$source['sname']}</option>
                                        {/foreach}
                                    </select>
                                </div>


                                <div class="mb-3"><label for="industry">{$_L['Industry']}</label>
                                ...
                                {*<div class="mb-3"><label for="">{$_L['No. of Employees']}</label>*}
                                {*<div class="col-md-12">*}
                                {*<input type="text" id="" name="" class="form-control" value="{$val['']}">*}
                                {*</div>*}
                                {*</div>*}

                                {*<div class="mb-3"><label for="rating">{$_L['Rating']}</label>*}
                                {*<div class="col-md-12">*}
                                ...
                                <fieldset class="mt-3">
                                    ...
                                    <div class="mb-3"><label for="memo">{$_L['Memo']}</label>
