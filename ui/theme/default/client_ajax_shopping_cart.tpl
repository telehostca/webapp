...
<div class="panel">
    <div>
        ...
        {if $cart && $cart->item_count > 0}
            ...
            <div class="panel-container">
                <div class="panel-content">
                    <div class="top-cart-action clearfix" style="padding-bottom: 0;">
                        ...
                        <span class="top-checkout-price t600 h3 text-end pull-right" style="color: #333;">{$_L['Total']}: {ib_money_format($cart->total,$config)}</span>
            ...
            <div class="panel-container">
                <div class="panel-content">
                    <a class="btn btn-danger text-end" href="{$_url}cart/clear">Clear</a>
                    <a class="btn btn-primary text-end pull-right" href="{$_url}cart/checkout">Checkout</a>
