                ...
                <div class="panel-container" id="ibox_form">
                    <div class="panel-content">
                        ...
                        <form class="form-horizontal" id="rform">
                            ...
                            <div class="mb-3"><label for="name">{$_L['Name']}*</label>
                                <input type="text" id="name" name="name" class="form-control" autocomplete="off">
                            </div>

                            <div class="mb-3">
                                <div class="mb-2">
                                    <label for="show_in_catalog">{__('Show in catalog')}</label>
                                </div>
                                <label class="switch s-icons s-outline s-outline-primary">
                                    <input type="checkbox" id="show_in_catalog" name="show_in_catalog" value="1">
                            ...
                            {if $type eq 'Product'}
                                ...
                                <div class="mb-3"><label for="cost_price">{$_L['Cost Price']}</label>
                            ...
                            <div class="mb-3"><label for="sales_price">{$_L['Sales Price']}</label>
                            ...
                            <div class="mb-3"><label for="item_number">{$_L['Item Number']}</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="tax1_rate" id="tax1_rate" class="form-control">
                            </div>
                            ...
                            <div class="mb-3"><label for="description">{$_L['Description']}</label>
                            ...
                            {if $type eq 'Product'}
                                ...
                                <div class="mb-3"><label for="inventory">{$_L['Inventory To Add Subtract']}</label>

                                    <input type="text" id="inventory" name="inventory" class="form-control" autocomplete="off">
                                </div>


                                <div class="mb-3"><label for="unit">{$_L['Unit']}</label>
