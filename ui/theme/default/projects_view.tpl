...
{block name="project_content"}
    ...
    <div class="col-md-12">
        <div class="panel-content">
            ...
            <span class="badge badge-outline-success mb-4">{$project->status}</span>
            ...
            <div class="mb-5" >
                <p class="text-muted"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    </svg> <span class="h5">{{__('Budget')}}</span><br>
                <h4>
                    <span class="badge badge-outline-info h5">{$project->budget}</span></p>
                </h4>
            ...
            <div class="row">
                <div class="col mb-3">
                    <p class="text-muted"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        </svg><span class="fw-bolder text-dark">{{__('Start Date')}}</span> <br>
                    <h4><span class="badge badge-outline-success">{$project->start_date}</span></h4>
                    </p>
                </div>
                <div class="col">
                    <p class="text-muted"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        </svg> <span class="text-dark fw-bolder">{{__('Due Date')}}</span> <br>
                    <h4><span class="badge badge-outline-danger">{$project->due_date}</span></h4></p>
                </div>
            ...
            {if $has_tasks}
                ...
                <div class="progress mb-3" style="height: 7px;">
                    <div class="progress-bar bg-info" role="progressbar" aria-valuenow="34" aria-valuemin="0" aria-valuemax="100" style="width: {round(($tasks_status[$project->id]['completed']*100)/$tasks_status[$project->id]['total'])}%;">
                    </div>
                </div>
