                ...
                <div class="ibox-content">
                    ...
                    <form id="create_ticket" class="form-horizontal push-10-t push-10" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            {*<div class="col-xs-4">*}
                            {*<div class="form-material floating">*}
                            {*<select class="form-select" id="contact3-subject" name="contact3-subject" size="1">*}
                        ...
                        <div class="mb-3">
                            <div class="col-xs-12">
                                ...
                                <div class="help-block"><a data-bs-toggle="modal" href="#modal_add_item"><i class="fal fa-paperclip"></i> Attach File</a> </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="col-xs-12">
