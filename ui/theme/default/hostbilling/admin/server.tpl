            ...
            <div class="card-body">
                ...
                <form method="post" id="form_main">
                    ...
                    {elseif $selected_type === 'directadmin'}
                        ...
                        {if !empty($input_require_for_this_server_type['ip_address'])}

                            <div class="mb-3">
                                <label>{if !empty($input_require_for_this_server_type['ip_address']['label'])} {$input_require_for_this_server_type['ip_address']['label']} {else} ip_address{/if}</label>
                                <input class="form-control" name="ip_address"
                                        {if $server}
                                            value="{$server->ip_address}"
                                        {/if}
