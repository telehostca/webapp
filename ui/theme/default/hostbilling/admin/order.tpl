                            ...
                            <div class="user-info-wrapper">
                                ...
                                <div class="d-flex flex-wrap my-50 mb-2">
                                    <div class="user-info-title text-muted">
                                        ...
                                        <span class="card-text user-info-title text-muted font-weight-bold mb-0 ms-3">{$_L['Date']}</span>
                                    </div>
                                ...
                                <div class="d-flex flex-wrap my-50 mb-2">
                                    <div class="user-info-title text-muted">
                                        ...
                                        <span class="card-text user-info-title text-muted  font-weight-bold mb-0 ms-3">{$_L['Tracking Id']}</span>
                                    </div>
                                ...
                                <div class="d-flex flex-wrap my-50 mb-2">
                                    <div class="user-info-title text-muted">
                                        ...
                                        <span class="card-text user-info-title text-muted  font-weight-bold mb-0 ms-3">{$_L['Client']}</span>
                                    </div>
                                    <p class="card-text mb-0">
                                ...
                                <div class="d-flex flex-wrap my-50 mb-2">
                                    <div class="user-info-title text-muted">
                                        ...
                                        <span class="card-text user-info-title text-muted font-weight-bold mb-0 ms-3">{$_L['Address']}</span>
                                    </div>
                                    <p class="card-text mb-0">
                                ...
                                <div class="d-flex flex-wrap mb-2">
                                    <div class="user-info-title text-muted">
                                        ...
                                        <span class="card-text user-info-title  text-muted font-weight-bold mb-0 ms-3">{$_L['City']}</span>
                                    </div>
                                    <p class="card-text mb-0">
                                ...
                                <div class="d-flex flex-wrap mb-2">
                                    <div class="user-info-title text-muted">
                                        ...
                                        <span class="card-text user-info-title  text-muted font-weight-bold mb-0 ms-3">{$_L['Country']}</span>
                                    </div>
                                    <p class="card-text mb-0">
                            ...
                            <div class="user-info-wrapper">
                                ...
                                <div class="d-flex flex-wrap my-50 mb-2">
                                    <div class="user-info-title text-muted">
                                        ...
                                        <span class="card-text user-info-title text-muted  font-weight-bold mb-0 ms-3">{$_L['Amount']}</span>
                                    </div>
                                    <p class="card-text mb-0">
                                        {$order->total}
                                    </p>
                                ...
                                <div class="d-flex flex-wrap my-50 mb-2">
                                    <div class="user-info-title text-muted">
                                        ...
                                        <span class="card-text user-info-title text-muted  font-weight-bold mb-0 ms-3">{$_L['Invoice Number']}</span>
                                    </div>
                                ...
                                <div class="d-flex flex-wrap my-50 mb-2">
                                    <div class="user-info-title text-muted">
                                        ...
                                        <span class="card-text user-info-title text-muted font-weight-bold mb-0 ms-3">{$_L['Status']}</span>
                                    </div>
                                    <p class="card-text mb-0">
                                ...
                                <div class="d-flex flex-wrap mb-2">
                                    <div class="user-info-title text-muted">
                                        ...
                                        <span class="card-text user-info-title  text-muted font-weight-bold mb-0 ms-3">{$_L['Type']}</span>
                                    </div>
                                ...
                                <div class="d-flex flex-wrap mb-2">
                                    <div class="user-info-title text-muted">
                                        ...
                                        <span class="card-text user-info-title  text-muted font-weight-bold mb-0 ms-3">{$_L['Domain']}</span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                {if !$order->automation_run}
                                    ...
                                    <a href="javascript:;" onclick="confirmThenGoToUrl(event,'hostbilling/mark-automation-run/{$order->id}');" class="btn btn-primary mb-3">{__('Mark as account created')}</a>
