                ...
                <div class="">
                    <div class=" flex-column justify-content-between border-container-lg">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="thumb-info mb-md">
                                    {if $contact['img'] eq 'gravatar'}
                                        <img src="http://www.gravatar.com/avatar/{md5($d['email'])}?s=400"  style="max-width: 120px; class=" class="img-thumbnail img-responsive" alt="{$contact['fname']} {$contact['lname']}">
                        ...
                        {if $config['add_fund'] eq '1'}
                            ...
                            <h3 class="mb-2">{$_L['Balance']} : <span class="amount">{{formatCurrency($contact->balance,$config['home_currency'])}}</span></h3>
                    ...
                    <div class="user-info-wrapper mt-3">
                        ...
                        <div class="d-flex flex-wrap my-50 mb-2">
                            <div class="user-info-title text-muted">
                                ...
                                <span class="card-text user-info-title text-muted font-weight-bold mb-0 ms-3">{$_L['Company Name']}</span>
                            </div>
                        ...
                        <div class="d-flex flex-wrap my-50 mb-2">
                            <div class="user-info-title text-muted">
                                ...
                                <span class="card-text user-info-title text-muted  font-weight-bold mb-0 ms-3">{$_L['Tags']}</span>
                            </div>
                            <p class="card-text mb-0">
                                {$contact->tags}
                            </p>
                        ...
                        <div class="d-flex flex-wrap my-50 mb-2">
                            <div class="user-info-title text-muted">
                                ...
                                <span class="card-text user-info-title text-muted  font-weight-bold mb-0 ms-3">{$_L['Group']}</span>
                            </div>
                            <p class="card-text mb-0">
                                {$contact->gname}
                            </p>
            ...
            <div class="card-body">
                <div class="panel-content">
                    ...
                    <ul class="nav nav-pills nav-justified">
                        <li class="nav-item"><a class="nav-link fw-bolder {if $tab == 'orders'}active{/if}" href="{$base_url}contacts/view/{$contact->id}/orders/"><strong>{$_L['Hosting Orders']}</strong></a></li>
            ...
            $(function () {
                ...
                $('.add_fund').on('click',function (e) {
                    ...
                    (async () => {
                        ...
                        if (amount) {
                            $.redirectPost(base_url + "contacts/add_fund/",{ amount: amount, cid: '{$contact->id}'});
                        }
                ...
                $('.return_fund').on('click',function (e) {
                    ...
                    (async () => {
                        ...
                        if (amount) {
                            $.redirectPost(base_url + "contacts/return_fund/",{ amount: amount, cid: '{$contact->id}'});
                        }
