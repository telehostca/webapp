                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="type">
                                ...
                                <option value="dedicated-server"
                                        {if $selected_group}
                                            {if $selected_group->type === 'dedicated-server'}
                                                selected
                                            {/if}
                                        {/if}
                                >{__('Dedicated Server')}</option>

                                <option value="object-storage"
                                        {if $selected_group}
                                            {if $selected_group->type === 'object-storage'}
                                                selected
                                            {/if}
                                        {/if}
                                >{__('Object Storage')}</option>

                                <option value="ssl-certificate"
                                        {if $selected_group}
                                            {if $selected_group->type === 'ssl-certificate'}
                                                selected
                                            {/if}
                                        {/if}
                                >{__('SSL Certificate')}</option>
