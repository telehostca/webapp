                    ...
                    <div class="col-md-3 ib_profile_width">
                        ...
                        <div class="panel panel-default" id="ibox_panel">
                            ...
                            <div class="panel-body list-group border-bottom m-t-n-lg">
                                <a href="#" id="summary" class="list-group-item active li_summary"><span class="fal fa-chart-bar me-2"></span> {$_L['Summary']} </a>
                                <a href="#" id="memo" class="list-group-item li_memo"><span class="fal fa-file-alt me-2"></span> {$_L['Memo']}</a>
                                <a href="#" id="customers" class="list-group-item li_customers"><span class="fal fa-users me-2"></span> {$_L['Customers']} <span class="badge badge-primary float-end">{Companies::countCustomers($company->id)}</span></a>

                                <a href="#" id="invoices" class="list-group-item li_invoices"><span class="fal fa-credit-card me-2"></span> {$_L['Invoices']} <span class="badge badge-primary float-end">{Companies::countInvoices($company->id)}</span></a>

                                <a href="#" id="quotes" class="list-group-item li_quotes"><span class="fal fa-file me-2"></span> {$_L['Quotes']} <span class="badge badge-primary float-end">{Companies::countQuotes($company->id)}</span></a>


                                <a href="#" id="orders" class="list-group-item li_orders"><span class="fal fa-server me-2"></span> {$_L['Orders']} <span class="badge badge-primary float-end">{Companies::countOrders($company->id)}</span></a>
                                ...
                                <a href="#" id="transactions" class="list-group-item li_transactions"><span class="fal fa-th-list me-2"></span> {$_L['Transactions']} <span class="badge badge-primary float-end">{Companies::countTransactions($company->id)}</span></a>
