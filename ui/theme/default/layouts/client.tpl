    ...
    <aside class="page-sidebar">
        ...
        <nav id="clx-primary-navigation" class="primary-nav" role="navigation">
            ...
            <div class="info-card">
                ...
                {else}
                    <span class="clx-avatar ">{$user->account[0]}</span>
            ...
            <ul id="clx-navigation-menu" class="nav-menu">
                ...
                {if !empty($config['subscriptions']) && $config['subscriptions'] }
                    ...
                    <li class="{if $selected_navigation eq 'subscriptions'}active  open{/if}">
                        <a href="#">
                            ...
                            <span class="nav-link-text">{$_L['Subscriptions']}</span>
                        </a>
                        <ul>

                            <li>
                                <a href="{$_url}subscriptions/all-subscriptions" >
                                    <span class="nav-link-text">{{__('Subscription Plans')}}</span>
                                </a>
                            </li>

                            <li>
                                <a href="{$_url}subscriptions/my-subscriptions">
                                    <span class="nav-link-text">{{__('My subscriptions')}}</span>
                                </a>
                            </li>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M5.5,15 L18.5,15 C19.3284271,15 20,15.6715729 20,16.5 C20,17.3284271 19.3284271,18 18.5,18 L5.5,18 C4.67157288,18 4,17.3284271 4,16.5 C4,15.6715729 4.67157288,15 5.5,15 Z M5.5,10 L18.5,10 C19.3284271,10 20,10.6715729 20,11.5 C20,12.3284271 19.3284271,13 18.5,13 L5.5,13 C4.67157288,13 4,12.3284271 4,11.5 C4,10.6715729 4.67157288,10 5.5,10 Z" fill="#000000" opacity="0.3"/>
            ...
            <div class="ms-auto d-flex">
                ...
                <div>
                    <a href="javasctipt:;" class="header-icon cursor-pointer" data-bs-toggle="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end p-0">
                            ...
                            <div class="list-group rounded-0">
                                {foreach $languages as $language}
                                    ...
                                    {if $language['iso_code'] eq 'test'} {continue} {/if}
