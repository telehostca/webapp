    ...
    <div class="mail-box">
        ...
        <div class="mail-body">
            ...
            <form class="form-horizontal" method="get">
                <div class="mb-3"><label class="col-sm-2 control-label" for="toemail">{$_L['To']}:</label>

                    <div class="col-sm-10"><input type="text" id="toemail" name="toemail" class="form-control" value="{$email}"></div>
                </div>
                <div class="mb-3"><label class="col-sm-2 control-label" for="subject">{$_L['Subject']}:</label>
