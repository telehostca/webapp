...
<table class="table table-bordered table-hover sys_table">
    ...
    <tr>
        ...
        <th>{$_L['Type']}</th>
        <th class="text-end" width="120px;">{$_L['Manage']}</th>
    </tr>
    </thead>
    <tbody>
    ...
    {foreach $i as $ds}
        <tr>
            ...
            <td class="text-end">
                ...
                <a href="{$_url}purchases/view/{$ds['id']}/" class="btn btn-primary btn-xs" data-bs-toggle="tooltip" data-placement="top" title="{$_L['View']}"><i class="fal fa-file-text-o"></i></a>
                <a href="{$_url}purchases/clone/{$ds['id']}/" class="btn btn-success btn-xs" data-bs-toggle="tooltip" data-placement="top" title="{$_L['Clone']}"><i class="fal fa-files-o"></i></a>
                <a href="{$_url}purchases/edit/{$ds['id']}/" class="btn btn-info btn-xs" data-bs-toggle="tooltip" data-placement="top" title="{$_L['Edit']}"><i class="fal fa-pencil"></i></a>
                <a href="#" class="btn btn-danger btn-xs cdelete" id="iid{$ds['id']}" data-bs-toggle="tooltip" data-placement="top" title="{$_L['Delete']}"><i class="fal fa-trash"></i></a>
