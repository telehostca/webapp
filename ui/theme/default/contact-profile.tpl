        ...
        <div class="col-md-4">
            <section class="panel">
                <div class="panel-body">
                    ...
                    <div class="btn-group">
                        <button data-bs-toggle="dropdown" class="btn btn-primary dropdown-toggle">Add New <span class="caret"></span></button>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <form class="form-horizontal" id="rform">
                                    ...
                                    <div class="mb-3"><label class="col-lg-2 control-label" for="fname">First Name</label>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <form class="form-horizontal" id="more">
                                    ...
                                    <div class="mb-3"><label class="col-lg-2 control-label" for="picture">Picture</label>
                                    ...
                                    <div class="mb-3"><label class="col-lg-2 control-label" for="facebook">Facebook Profile</label>
                                    ...
                                    <div class="mb-3"><label class="col-lg-2 control-label" for="google">Google Plus Profile</label>

                                        <div class="col-lg-10"><input type="text" id="google" name="google" class="form-control" value="{$d['google']}" autocomplete="off">

                                        </div>
                                    </div>
                                    <div class="mb-3"><label class="col-lg-2 control-label" for="linkedin">Linkedin Profile</label>
