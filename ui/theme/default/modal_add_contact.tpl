        ...
        <div class="panel-container">
            <div class="panel-content">
                <form class="form-horizontal" id="rform">
                    ...
                    <div class="mb-3"><label for="account">{$_L['Full Name']}</label>
                        <input type="text" id="account" name="account" class="form-control" >
                    </div>

                    <div class="mb-3"><label for="company">{$_L['Company Name']}</label>
                    ...
                    <div class="mb-3"><label for="m_address">{$_L['Address']}</label>
