...
class Img
{
    ...
    /**
     * @var mixed|resource|\GdImage|bool
     */
     ...
     */
    public $target_type;
    public array $source_transparent_color;
    /**
     * @var int|bool|mixed
     */
    ...
    public function apply_filter(
        ...
        if (function_exists('imagefilter') && $this->_create_from_source()) {
    ...
    private function _hex2rgb($color, $default_on_error = '#FFFFFF')
    {
        ...
        if (
            preg_match('/^#?([a-f]|\d){3}(([a-f]|\d){3})?$/i', $color) ==
            0
        ) {
    ...
    private function _write_image($identifier)
    {
        ...
        // if target file has to have the same timestamp as the source image
        if ($this->preserve_time && (property_exists($this, 'source_image_time') && $this->source_image_time !== null)) {
