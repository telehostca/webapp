...
class DirectoryLister {
    ...
    public function getListedPath() {
        ...
        // Build the path
        $path = $this->_directory == '.' ? $this->_appURL : $this->_appURL . $this->_directory;
    ...
    protected function _getRelativePath($fromPath, $toPath) {
        ...
        if(trim($fromPathArray[$x]) === '' || trim($fromPathArray[$x]) === '0') {
        ...
        if(trim($toPathArray[$x]) === '' || trim($toPathArray[$x]) === '0') {
