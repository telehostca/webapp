    ...
    case 'GET':
        switch ($action) {
            ...
            case 'object-storage':
                ...
                elseif ($action === 'cloud-vps') {
                    $type = 'vps';
                }
                elseif ($action === 'dedicated-servers') {
                    $type = 'dedicated-server';
                }
                elseif ($action === 'ssl-certificates') {
                    $type = 'ssl-certificate';
                }
                elseif ($action === 'object-storage') {
                    $type = 'object-storage';
                }
                ...
                elseif ($type === 'vps') {
                    $hosting_plan = $hosting_plan->where('type', 'vps');
                }
                elseif ($type === 'dedicated-server') {
                    $hosting_plan = $hosting_plan->where('type', 'dedicated-server');
                }
                elseif ($type === 'ssl-certificate') {
                    $hosting_plan = $hosting_plan->where('type', 'ssl-certificate');
                }
                elseif ($type === 'object-storage') {
                    $hosting_plan = $hosting_plan->where('type', 'object-storage');
                }
            ...
            case 'order':
                ...
                if ($id !== '' && $id !== '0') {
                    ...
                    if ($order) {
                        ...
                        if ($plan && $plan->hosting_provider_id) {
            ...
            case 'server':
                ...
                $selected_type = $server ? $server->type : route(3);
            ...
            case 'domain-registration-provider':
                ...
                $selected_type = $domain_registration_provider ? $domain_registration_provider->type : route(3);
                        ...
                        elseif ($server->type === 'directadmin') {
                            ...
                            $response = $http
                                ...
                                ->get(
                                    'https://' .
                                    $server->host .
                                    ':2222/CMD_API_SHOW_USERS?json=yes');
            ...
            case 'mark-automation-run':
                ...
                redirect_to('hostbilling/order/'.$id);
                break;
        ...
        switch ($action) {
            ...
            case 'domain-pricing':
                ...
                if ($validation->fails()) {
                    ...
                    $registration_provider_id =
                        (int) $data['registration_provider_id'] ?? 0;

                    $domain_price->registration_provider_id = $registration_provider_id;
            ...
            case 'server':
                ...
                if ($hosting_server) {
                    ...
                    $hosting_server->ip_address = $data['ip_address'] ?? null;
