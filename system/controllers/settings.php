...
switch ($action) {
    ...
    case 'eml-post':
        ...
        if ($email_method == 'smtp') {
            ...
            if (
                $smtp_user == '' || $smtp_password == '' || $smtp_port == '' || $smtp_host == ''
            ) {
...
//                $e->secure = $smtp_secure;
    ...
    case 'lc-post':
        ...
        if ($cformat == '1') {
            $d = AppConfig::where('setting', 'dec_point')
                ->first();
            $d->value = '.';
            $d->save();
            $d = AppConfig::where('setting', 'thousands_sep')
                ->first();
            $d->value = '';
            $d->save();
        } elseif ($cformat == '2') {
        ...
        $d = AppConfig::where('setting', 'currency_code')
            ->first();
        ...
        $d = AppConfig::where('setting', 'home_currency')
            ->first();
...
//        }
    ...
    case 'pg-conf':
        ...
        if ($d) {
            ...
            AppEvent::trigger('settings/pg_conf/label', [$processor]);
    ...
    case 'edit-tax':
        ...
        if ($d) {
            ...
            AppEvent::trigger('settings/edit-tax/');
