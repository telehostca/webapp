 ...
 ?></strong></span>
    ...
    'account'
     ...
     'state'
            ...
            <tr>
                ...
                <td><?php echo ib_lan_get_line($d['stage']); ?></td>
            </tr>
            <tr>
    ...
    <table id="items">
        ...
        <tr>
            ...
            <td class="total-value"><div id="subtotal"><?php echo ib_money_format(
                $d['subtotal'],
                $config,
                $d['currency_symbol']
            ); ?></div></td>
        ...
        <?php if ($d['tax'] != '0.00') { ?>
            <tr>
                ...
                <td class="total-value"><div id="total"><?php echo ib_money_format(
                    $d['tax'],
                    $config,
                    $d['currency_symbol']
                ); ?></div></td>
        ...
        <?php if ($d['credit'] != '0.00') { ?>
            <tr>
                ...
                <td class="total-value"><div class="due"><?php echo ib_money_format(
                    $d['total'],
                    $config,
                    $d['currency_symbol']
                ); ?></div></td>
            ...
            <tr>
                ...
                <td class="total-value balance"><div class="due"><?php echo ib_money_format(
                    $i_due,
                    $config,
                    $d['currency_symbol']
                ); ?></div></td>
