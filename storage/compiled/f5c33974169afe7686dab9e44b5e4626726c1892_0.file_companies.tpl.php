<?php
/* Smarty version 5.4.2, created on 2024-11-26 08:55:23
  from 'file:../default/companies.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.2',
  'unifunc' => 'content_6745d34b554c95_17074141',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f5c33974169afe7686dab9e44b5e4626726c1892' => 
    array (
      0 => '../default/companies.tpl',
      1 => 1690425606,
      2 => 'file',
    ),
  ),
...
function content_6745d34b554c95_17074141 (\Smarty\Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_4277897536745d34b53f314_94148146', "content");
?>



<?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_15165102306745d34b54e968_57217626', "script");
?>

<?php $_smarty_tpl->getInheritance()->endChild($_smarty_tpl, ((string)$_smarty_tpl->getValue('layouts_admin')), $_smarty_current_dir);
}
/* {block "head"} */
class Block_8428367256745d34b53f9d7_62117525 extends \Smarty\Runtime\Block
{
...
/* {/block "head"} */
/* {block "content"} */
class Block_4277897536745d34b53f314_94148146 extends \Smarty\Runtime\Block
{
public function callBlock(\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = '/Users/razib/Herd/hbpro/ui/theme/default';
?>
    ...
    <?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_8428367256745d34b53f9d7_62117525', "head", $this->tplIndex);
?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                ...
                <div class="panel-hdr">
                    <h2><?php echo $_smarty_tpl->getValue('_L')['Companies'];?>
</h2>

                    <div class="panel-toolbar">
                        <a href="#" class="btn btn-primary add_company waves-effect waves-light" id="add_company"><?php echo $_smarty_tpl->getValue('_L')['New Company'];?>
</a>
                            ...
                            <table class="table w-100" id="clx_datatable">
                                <thead
                                        <?php if (empty($_smarty_tpl->getValue('config')['admin_dark_theme'])) {?>
                                         ...
                                         >
                                <tr>
                                    <th class="bold"><?php echo $_smarty_tpl->getValue('_L')['Logo'];?>
</th>
                                    <th class="bold"><?php echo $_smarty_tpl->getValue('_L')['Company Name'];?>
</th>
                                    <th class="bold"><?php echo $_smarty_tpl->getValue('_L')['Email'];?>
</th>
                                    <th class="bold"><?php echo $_smarty_tpl->getValue('_L')['Phone'];?>
</th>
                                    <th class="text-end bold"><?php echo $_smarty_tpl->getValue('_L')['Manage'];?>
</th>
                                </tr>
                                </thead>
                                <tbody>
...
?>
                                    <tr data-id="<?php echo $_smarty_tpl->getValue('company')['id'];?>
">
                                        <td>

                                            <?php if ($_smarty_tpl->getValue('company')['logo_url'] != '') {?>
                                                <img style="max-height: 40px;" src="<?php echo $_smarty_tpl->getValue('app_url');?>
storage/companies/<?php echo $_smarty_tpl->getValue('company')->logo_url;?>
">
                                            <?php } else { ?>
                                                <span class="clx-avatar"><?php echo $_smarty_tpl->getValue('company')['company_name'][0];?>
</span>
                                            <?php }?>

                                        </td>
                                        <td>
                                            <a class="cview" id="ae<?php echo $_smarty_tpl->getValue('company')['id'];?>
" href="#">
                                                <strong>
                                                    <?php echo $_smarty_tpl->getValue('company')['company_name'];?>

                                                    <?php if ($_smarty_tpl->getValue('company')['code'] != '') {?>
                                                        <br>
                                                        <?php echo $_smarty_tpl->getValue('company')['code'];?>
                                        ...
                                        <td><a href="#" class="send_email text-info h6"><?php echo $_smarty_tpl->getValue('company')['email'];?>
</a> </td>
                                        <td class="h6"><?php echo $_smarty_tpl->getValue('company')['phone'];?>
</td>
                                        <td>
                                            <div class="d-flex float-end">
                                                <a href="<?php echo $_smarty_tpl->getValue('_url');?>
" id="ae<?php echo $_smarty_tpl->getValue('company')['id'];?>
" class="btn btn-secondary-light btn-icon cview me-2" data-bs-toggle="tooltip" title="<?php echo $_smarty_tpl->getValue('_L')['View'];?>
"><i class="fal fa-building"></i> </a>

                                                <a href="<?php echo $_smarty_tpl->getValue('_url');?>
" id="be<?php echo $_smarty_tpl->getValue('company')['id'];?>
" class="btn btn-secondary-light btn-icon cedit me-2" data-bs-toggle="tooltip" title="<?php echo $_smarty_tpl->getValue('_L')['Edit'];?>
"><i class="fal fa-pencil"></i> </a>

                                                <a href="#" class="btn btn-secondary-light btn-icon cdelete" id="c<?php echo $_smarty_tpl->getValue('company')['id'];?>
...
/* {/block "content"} */
/* {block "script"} */
class Block_15165102306745d34b54e968_57217626 extends \Smarty\Runtime\Block
{
public function callBlock(\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = '/Users/razib/Herd/hbpro/ui/theme/default';
?>
