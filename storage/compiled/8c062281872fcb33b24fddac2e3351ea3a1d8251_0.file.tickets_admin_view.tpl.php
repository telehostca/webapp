<?php
/* Smarty version 4.3.2, created on 2023-09-08 18:32:31
  from '/Users/razib/Documents/valet/hostbilling-pro/ui/theme/default/tickets_admin_view.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_64fba0ffb097a8_04979666',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8c062281872fcb33b24fddac2e3351ea3a1d8251' => 
    array (
      0 => '/Users/razib/Documents/valet/hostbilling-pro/ui/theme/default/tickets_admin_view.tpl',
      1 => 1690454404,
      2 => 'file',
    ),
  ),
...
function content_64fba0ffb097a8_04979666 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_78203291764fba0ffab17b4_07060911', "content");
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_70726509664fba0ffaf7c65_39492573', "script");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "content"} */
class Block_78203291764fba0ffab17b4_07060911 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_78203291764fba0ffab17b4_07060911',
  ),
);
            ...
            <div class="card border" id="t_options">
                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        <li class="nav-item active" role="presentation"><a data-bs-toggle="tab" href="javascript:;" class="nav-link active" data-bs-target="#details"><i class="fal fa-th"></i> <?php echo $_smarty_tpl->tpl_vars['_L']->value['Details'];?>
</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link" data-bs-toggle="tab" href="javascript:;" data-bs-target="#tasks"><i class="fal fa-tasks"></i> <?php echo $_smarty_tpl->tpl_vars['_L']->value['Tasks'];?>
</a></li>
                                ...
                                <div class="mb-3">
                                    <div class="col-xs-12">
                                        ...
                                        <div id="tasks_tools"  style="display: none;">
                                            ...
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-success no-shadow" id="btn_mark_tasks_completed" data-bs-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Mark as Completed'];?>
"><i class="fal fa-check"></i></button>
                                                <button type="button" class="btn btn-primary no-shadow" id="btn_mark_tasks_not_started" data-bs-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Mark as Not Started'];?>
"><i class="fal fa-clock"></i></button>
                                                <button type="button" class="btn btn-danger no-shadow" id="btn_delete_tasks" data-bs-toggle="tooltip" data-placement="top" title="<?php echo $_smarty_tpl->tpl_vars['_L']->value['Delete'];?>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-body">
                                    <form class="form-horizontal push-10-t push-10" method="post">
                                        ...
                                        <?php if (!empty($_smarty_tpl->tpl_vars['config']->value['openai_api_key'])) {?>
                                            <div class="mb-2">
                                                <button class="btn btn-primary" type="button" id="btn_generate_reply"><?php echo __('Generate Reply');?>
</button>
                                            </div>
                                        <?php }?>
...
/* {/block "content"} */
/* {block "script"} */
class Block_70726509664fba0ffaf7c65_39492573 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_70726509664fba0ffaf7c65_39492573',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
tickets/admin/get-predefined-reply/" + predefined_reply_id, function( data ) {
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            btn_generate_reply.addEventListener('click', () => {
                ...
                btn_generate_reply.innerHTML = '<i class="fal fa-spinner fa-spin"></i> <?php echo __('Generating');?>
...';
                let generate_reply_form = new FormData();
                generate_reply_form.append('ticket_id', <?php echo $_smarty_tpl->tpl_vars['ticket']->value->id;?>
);
...
tickets/admin/generate-reply', generate_reply_form).then(function (response) {
                    ...
                    btn_generate_reply.innerHTML = '<?php echo __('Generate Reply');?>
';
