<?php
/* Smarty version 5.4.2, created on 2024-12-14 18:32:25
  from 'file:../default/projects_timelog.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.2',
  'unifunc' => 'content_675e15897feae6_23814481',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '988edc2f91908d3e67fb2f445319681cd5665fce' => 
    array (
      0 => '../default/projects_timelog.tpl',
      1 => 1690425606,
      2 => 'file',
    ),
  ),
...
function content_675e15897feae6_23814481 (\Smarty\Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_1598038316675e15897f5d04_63011440', "project_content");
?>


<?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_585331128675e15897fc887_77932870', "script");
?>

<?php $_smarty_tpl->getInheritance()->endChild($_smarty_tpl, "project_base.tpl", $_smarty_current_dir);
}
/* {block "project_content"} */
class Block_1598038316675e15897f5d04_63011440 extends \Smarty\Runtime\Block
{
    ...
    <div id="modal_add_event" data-backdrop="static" class="modal fade-scale" tabindex="-1" data-width="800" style="display: none;">
        <form id="ib_modal_form">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modal_title"><?php echo $_smarty_tpl->getValue('_L')['Add Event'];?>
</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="mb-3 col-md-12">
                        <label for="title"><?php echo $_smarty_tpl->getValue('_L')['Event Name'];?>
</label>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="start"><?php echo $_smarty_tpl->getValue('_L')['Start Date'];?>
</label>
                        <input type="text" class="form-control" datepicker data-date-format="yyyy-mm-dd" data-auto-close="true" id="start" placeholder="Select Date" name="start" value="<?php echo $_smarty_tpl->getValue('mdate');?>
">
                    </div>

                    <div class="mb-3 col-md-6" id="start_time_div">
                        <label for="start_time"><?php echo $_smarty_tpl->getValue('_L')['Start Time'];?>
</label>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="end"><?php echo $_smarty_tpl->getValue('_L')['End Date'];?>
</label>
                    ...
                    <div class="mb-3 col-md-6" id="end_time_div">
                        <label for="end_time"><?php echo $_smarty_tpl->getValue('_L')['End Time'];?>
</label>
                        <div class="input-group">
                    ...
                    <div class="mb-3 col-md-12">
                        ...
                        <label for="all_day_event"><?php echo $_smarty_tpl->getValue('_L')['All day event'];?>
</label>
                    ...
                    <div class="mb-3 col-md-12">
                        <label for="color"><?php echo $_smarty_tpl->getValue('_L')['Color'];?>
</label>
            ...
            <div class="modal-footer">
                <a href="#" id="btn_del_event" class="btn btn-danger"><i class="fal fa-trash"></i> <?php echo $_smarty_tpl->getValue('_L')['Delete'];?>
</a>
                <button type="button" data-bs-dismiss="modal" class="btn btn-warning"><?php echo $_smarty_tpl->getValue('_L')['Close'];?>
</button>
                <button type="submit" id="btn_save_event" class="btn btn-primary"><?php echo $_smarty_tpl->getValue('_L')['Submit'];?>
</button>
            </div>
        </form>
    </div>
...
/* {/block "project_content"} */
/* {block "script"} */
class Block_585331128675e15897fc887_77932870 extends \Smarty\Runtime\Block
{
public function callBlock(\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = '/Users/razib/Herd/hbpro/ui/theme/default';
?>
